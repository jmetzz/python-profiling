...
check:
	...
	@printf "$(PURPLE)Import order$(COFF)\n"
	poetry run isort --check src tests
	@printf "$(PURPLE)Code formatting$(COFF)\n"
	poetry run black --check src tests
	@printf "$(PURPLE)pyling checks$(COFF)\n"
	poetry run pylint src tests
	@printf "$(PURPLE)mypy checks$(COFF)\n"
	poetry run mypy src # --ignore-missing-imports
	@printf "$(PURPLE)Generate licenses file$(COFF)\n"
